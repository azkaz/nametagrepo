		...
		<div id="formContainer" class="form-group">
			...
			<form action="DBconnection.php" method="post" target="_self" enctype="multiform/form-data">
				...
				<div id="canvasDateContainer">
					<div style="float:left;">
						<canvas id="snapshot" width="150px" height="182px" style="float:left;border:dashed 3px;border-color:red;"></canvas>
						<br>
						<a id="dlbtn" class="btn btn-success">Ladda Ner Bild</a>
					</div>
			...
			<div class=bottomButtons>
				<form action="printallcard.php">
					<input type="submit" name="print" value="Visa alla Besökare" class="btn btn-success" />
				</form>
			</div>
			<div class=bottomButtons>
				<form action="printsinglecard.php">
					<input type="submit" name="printsingle" value="Visa Senaste Besökaren" class="btn btn-success" />
				</form>
			</div>
			</div>
		</div>
